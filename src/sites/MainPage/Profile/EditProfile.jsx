...
function EditProfile() {
  ...
  const handleEditProfileField = async (field, value) => {
    ...
    try {
      const response = await apiFetch(
        `${BASE_URL}${ENDPOINTS.trainerProfiles}${userData?.trainer_id}/`,
        {
          method: "PATCH",
          body: formData,
        },
                  ...
                  {profileData?.certyficates?.map((cer, i) => (
                    <div key={i} className="certificate">
                      ...
                      <span className="cer-more-info">
                        Issued {formatDate1(cer.issued_date)}
                      </span>
                      <br />
                      <span className="cer-more-info">
                      ...
                      <div className="cer-btns">
                        <button
                          ...
                          onClick={() =>
                            handleClickEditCertyficate(
                              ...
                              cer.issued_by,
                              cer.identyficatior,
                              formatDate2(cer.issued_date).day,
                              formatDate2(cer.issued_date).month,
                              formatDate2(cer.issued_date).year,
                              cer.uploaded_images,
                            )
                          }
                          className="edit-pr-action-btn"
                        ...
                        <button
                          style={{ position: "static" }}
                          onClick={() => handleRemoveCertyficate(cer.id)}
                          className="edit-pr-action-btn"
                        >
                          Usuń
                          <img src={addIcon} />
                        ...
                        <div className="rec-event-more-info-wrapper">
                          <div className="rec-event-more-info">
                            <ul className="rec-event-more-info-list">
                              ...
                              <li>
                                <img src={recPeople} /> {ev.available_places}{" "}
                                miejsc
                              </li>
                            </ul>
                          </div>
        ...
        {selected == "place" && (
          <div className="place-create-box">
            <div className="cp-title-box">
              ...
              <p className="cp-desc">
                Wybierz, w jaki sposób chcesz dodać swoją placówkę — tylko
                oznacz ją na mapie lub zyskaj pełne możliwości zarządzania nią i
                wydarzeniami.
              </p>
            </div>
            <div className="place-choice-box">
              ...
              >
                <h3 className="place-choice-title">
                  Prowadź, planuj i działaj
                </h3>
                <img
                  src={
                    placeType == "second"
                ...
                <span className="place-choice-price">
                  Wstępny koszt 119 PLN
                </span>
              </div>
            </div>
