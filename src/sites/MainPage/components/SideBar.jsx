    ...
    <>
      <nav className={`sidebar ${ist4b ? "t4b" : ""}`}>
        ...
        <div className="sideicon-wrapper">
          <House 
            className={
              `sidebar-icon icon ${location.pathname == "/strona-glowna" ? 'sidebar-selected' : ''} ${ist4b ? 't4b' : ''}`
            } 
        ...
        <div className='sideicon-wrapper'>
          <Calendar 
            className={
                `sidebar-icon icon ${location.pathname == "/kalendarz" ? 'sidebar-selected' : ''} ${ist4b ? 't4b' : ''}`
            }  
        ...
        <div className='sideicon-wrapper'>
          <img
            ...
            className={
                `sidebar-icon icon ${location.pathname == "/eventy" ? 'sidebar-selected' : ''} ${ist4b ? 't4b' : ''}`
            }  
        ...
        <div className={`sideicon-wrapper ${ist4b ? 't4f' : 't4b'}`} id="last">
          <img 
            src={ist4b ? t4f : t4b} 
            alt="" 
            onClick={() => navigate(`${ist4b ? "/strona-glowna" : "/time-4-biz/menu-placowek"}`)}
          />
        </div>
      </nav>
    </>
